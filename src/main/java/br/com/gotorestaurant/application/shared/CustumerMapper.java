...
public abstract class CustumerMapper {
    ...
    public static br.com.gotorestaurant.core.entity.Customer toCustomer(CustomerEntity customerEntity){
       return new br.com.gotorestaurant.core.entity.Customer(customerEntity.getName(), customerEntity.getDocument()
